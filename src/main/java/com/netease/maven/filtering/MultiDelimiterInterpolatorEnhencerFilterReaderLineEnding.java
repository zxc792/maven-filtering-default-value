...
public class MultiDelimiterInterpolatorEnhencerFilterReaderLineEnding extends AbstractEnhancerFilterReaderLineEnding {
	/**
	 ...
	 */
	public MultiDelimiterInterpolatorEnhencerFilterReaderLineEnding(Reader in, Interpolator interpolator,
	 ...
	 *            interpolator instance to use
	 * @param ri
	 *            The {@link RecursionInterceptor} to use to prevent recursive
	 *            expressions.
	 * @param supportMultiLineFiltering
	 *            If multi line filtering is allowed
	 */
	public MultiDelimiterInterpolatorEnhencerFilterReaderLineEnding(Reader in, Interpolator interpolator,
		...
		// always cache answers, since we'll be sending in pure expressions, not
		// mixed text.
	 ...
	 */
	public AbstractEnhancerFilterReaderLineEnding setDelimiterSpecs(Set<String> specs) {
		delimiters.clear();
	 ...
	 *
	 * @param cbuf
	 *            Destination buffer to write characters to. Must not be
	 *            <code>null</code>.
	 * @param off
	...
	public int read() throws IOException {
		...
		// escape means no luck, prevent parsing of the escaped character, and
		// return
		if (inEscape) {
	...
	/**
	 * @return interpolate with prefix pattern {@code true} (active)
	...
	/**
	 * @param interpolateWithPrefixPattern
	 *            set the interpolate with prefix pattern.
	 */
	...
	/**
	 * @param givenRecursionInterceptor
	 *            {@link RecursionInterceptor}
	 * @return this
	 */
	// CHECKSTYLE_OFF: LineLength
	public AbstractEnhancerFilterReaderLineEnding setRecursionInterceptor(
